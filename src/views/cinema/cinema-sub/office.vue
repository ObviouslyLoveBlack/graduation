  ...
  <div class="office-container">
    <div class="office-content">
      <div class="office-table">
        ...
        <tbody>
          <tr
            v-for="(action, index) in tableData"
            :key="index"
            @click="getDetailFilms(action)"
          >
            <td>
              ...
              <div class="td-box">
                ...
                <p>
                  上映{{ action.money }}天，{{
                    action.shown > 100000000
                      ? (action.shown / 100000000).toFixed(2) + "亿"
                      : action.shown > 10000
                      ? (action.shown / 10000).toFixed(2) + "万"
                      : ""
                  }}
                </p>
              </div>
      ...
      <div class="office-detail">
        <div class="real-time-market">
          <h3>实时大盘</h3>
          <h3>{{ 4067.1 }} <span>万</span></h3>
          <div class="real-market-info">
            <span>总出票：{{ 108.6 }}万张</span>
            <span>总场次：{{ 32.4 }}万场</span>
          </div>
        </div>
        <div class="office-detail-info">
          <div class="office-image-info">
            ...
            <div class="films-info">
              ...
              <p>
                上映{{ detailObj.money }}天,{{
                  detailObj.shown > 100000000
                    ? (detailObj.shown / 100000000).toFixed(2) + "亿"
                    : detailObj.shown > 10000
                    ? (detailObj.shown / 10000).toFixed(2) + "万"
                    : ""
                }}
              </p>
            </div>
...
export default {
  ...
  methods: {
    currentDate(key) {
      return this.$moment().subtract(key, "days").format("M-DD").split('-').join('/');
    },
    async getOfficeData() {
            ...
            label: {
              ...
              formatter: function (params) {
                if (params.data > 100000000)
                  return (params.data / 100000000).toFixed(2) + "亿";
